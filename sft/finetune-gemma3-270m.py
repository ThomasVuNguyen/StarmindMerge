...
dataset = load_dataset("ThomasTheMaker/tulu-3-sft-personas-instruction-following", split = "train[:10000]")
...
model.push_to_hub("ThomasTheMaker/gemma-3-270m-tulu-3-sft-personas-instruction-following", token = os.getenv("HF_TOKEN")) # Online saving
tokenizer.push_to_hub("ThomasTheMaker/gemma-3-270m-tulu-3-sft-personas-instruction-following", token = os.getenv("HF_TOKEN")) # Online saving
...
if True: # Pushing to HF Hub
    model.push_to_hub_merged("ThomasTheMaker/gemma-3-270m-tulu-3-sft-personas-instruction-following-16bit", tokenizer, save_method = "merged_16bit", token = os.getenv("HF_TOKEN"))
...
if True: # Save to GGUF
    model.save_pretrained_gguf(
        "gemma-3-270m-tulu-3-sft-personas-instruction-following-gguf",
        tokenizer,
...
if True: # Upload GGUF to Hugging Face
    model.push_to_hub_gguf(
        "gemma-3-270m-tulu-3-sft-personas-instruction-following-gguf",
        tokenizer,
        quantization_type = "Q8_0", # Only Q8_0, BF16, F16 supported
        repo_id = "ThomasTheMaker/gemma-3-270m-tulu-3-sft-personas-instruction-following-gguf",
